...
class GameSprite(sprite.Sprite):
    ...
    def __init__(self,player_image,player_x, player_y,size_x,size_y):
        #Вызываем конструктор класса (Sprait):
        sprite.Sprite.__init__(self)
        # каждый спрайт должен хранить свойтво image = изображение 
        self.image = transform.scale(image.load(player_image), (size_x, size_y))

        # каждый спрайт должен хранить свойтво rect -прмоугльник,в который он вписан
...
class Player(GameSprite):
    #метод, в котором реалтзовано управление спрайтом по кнопкам стрелкам клавиатуры
    def __init__(self,player_image,player_x, player_y,size_x,size_y,player_x_speed,player_y_speed):
        #Вызываем конструктор класа (Sprite):
    ...
    def fire(self):
        bullet = Bullet('paintball.png',self.rect.right, self.rect.centery,15,20,15)
        bullets.add(bullet)
...
class Enemy(GameSprite):
    ...
    #движение врага
    def update(self):
        if self.rect.x <= 420: #w1.wall_x + w1.wall_wight
            self.side = "right"
...
class Bullet(GameSprite):
    def __init__(self,player_image,player_x,player_y,size_x,size_y,player_speed):
        #Вызываем кнструктор класса (Sprite):
        GameSprite.__init__(self,player_image,player_x,player_y,size_x,size_y)
        self.speed = player_speed
...
while run:
    ...
    if not finish:
        ...
        #Проверка столкновения героя с врю и гер. 
        if sprite.spritecollide(packman,monsters,False):
            finish = True
            # вычисляем отношение
            ing = image.load('1258544.jpg')
